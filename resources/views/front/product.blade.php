                    ...
                    <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light">
                            ...
                            <div class="carousel-item {{ ($key == 0 )?'active': '' }}">
                                <img class="w-100 h-100" src="{{ asset('uploads/product/'.$productimg->image) }}" alt="Image">
                            </div>
                            @endforeach
                            @else
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            ...
                            @if($relatedProduct->productImages->isNotEmpty())
                              <img class="card-img-top img-thumbnail" src="{{ asset('uploads/product/'.$relatedProduct->productImages->first()->image) }}"/>
                            @else
                              <img class="card-img-top img-thumbnail" src="{{ asset('images/default.png') }}"/>
                            @endif
